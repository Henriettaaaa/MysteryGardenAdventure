...
void MainScene::initButtons() {
    ...
    multiPlayerNetworkButton.setup(400, 480, 200, 50, font, "double_network");
    multiPlayerNetworkButton.setColors(idleColor, hoverColor);
    ...
    multiPlayerNetworkButton.setCallback([this]() {
        currentState = SceneState::MULTI_PLAYER_NETWORK;
        });
...
void MainScene::updateButtons(const sf::Vector2f& mousePos) {
    ...
    multiPlayerNetworkButton.update(mousePos);
...
void MainScene::handleButtonClicks(const sf::Vector2f& mousePos) {
    ...
    else if (multiPlayerNetworkButton.isMouseOver(mousePos)) {
        multiPlayerNetworkButton.callback();
    }
...
void MainScene::render() {
    ...
    multiPlayerNetworkButton.draw(window);
